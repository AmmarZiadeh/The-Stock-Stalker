...
dataset = pd.read_csv("Six Flags Stock.csv")
print(dataset.head())
print()
...
# lstm_model.save("six_flags_lstm_model.h5")
...
plt.title("Six Flags Stock Price Prediction")
plt.xlabel("Date")
plt.ylabel("Six Flags Stock Price")
